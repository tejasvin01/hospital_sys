...
const WelcomePage = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        featureModalRef.current &&
        !featureModalRef.current.contains(event.target)
      ) {
        closeFeatureModal();
      }
    };
  ...
  const featureCategories = {
    clinical: {
      ...
      color: "blue",
      description:
        "Powerful tools for healthcare providers to deliver exceptional patient care",
      features: [
        {
          id: "doctor-mgmt",
          icon: "fa-user-md",
          ...
          fullDescription:
            "Our comprehensive doctor management system streamlines physician scheduling, credentialing, and departmental assignments. Track performance metrics, manage on-call rotations, and ensure optimal coverage across all departments.",
          benefits: [
          ...
          image:
            "https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
        },
        {
          id: "patient-records",
          icon: "fa-users",
          ...
          fullDescription:
            "Maintain comprehensive, HIPAA-compliant electronic health records that provide a complete view of patient health history. Our system allows for secure access across departments while maintaining strict privacy controls.",
          benefits: [
          ...
          image:
            "https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
        },
        {
          ...
          fullDescription:
            "Our smart appointment system optimizes clinic schedules, reduces wait times, and minimizes no-shows through automated reminders. The system intelligently balances physician workloads while prioritizing urgent care needs.",
          benefits: [
    ...
    administrative: {
      ...
      color: "purple",
      description:
        "Streamline operations and manage your facility with maximum efficiency",
      features: [
        {
          id: "medical-reports",
          ...
          fullDescription:
            "Create standardized or custom medical reports for patients, departments, or regulatory compliance with our powerful reporting engine. The system automatically pulls relevant data, reducing documentation time by up to 60%.",
          benefits: [
          ...
          image:
            "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
        },
        {
          id: "inventory-mgmt",
          icon: "fa-boxes",
          ...
          badge: "New",
          description:
            "Track medical supplies, set reorder points, and manage vendor relationships.",
          fullDescription:
            "Our inventory management system provides real-time tracking of medical supplies, equipment, and pharmaceuticals. Get alerts when supplies are running low, track usage patterns, and optimize procurement to reduce costs.",
          benefits: [
          ...
          image:
            "https://images.unsplash.com/photo-1587351021759-3e566b3db4f1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
        },
        {
          id: "staff-scheduling",
          icon: "fa-user-clock",
          ...
          description:
            "Create optimal staff schedules that balance workload and availability.",
          fullDescription:
            "Efficiently manage the complex scheduling needs of your healthcare facility. Our system considers staff qualifications, department needs, shift preferences, and compliance requirements to create optimal schedules.",
          benefits: [
    ...
    financial: {
      ...
      color: "green",
      description:
        "Optimize revenue cycles and maintain financial health with our integrated solutions",
      features: [
        {
          id: "billing-payments",
          icon: "fa-money-bill-wave",
          ...
          fullDescription:
            "Our comprehensive billing system handles the entire revenue cycle, from insurance verification to claim submission and payment posting. Reduce denials, accelerate collections, and improve your bottom line.",
          benefits: [
        ...
        },
        {
          ...
          description:
            "Track revenue streams, manage claims, and reduce revenue leakage.",
          fullDescription:
            "Maximize your facility's financial performance with our revenue cycle management tools. Identify bottlenecks, reduce claim rejections, and accelerate payments through analytics-driven insights and automation.",
          benefits: [
        ...
        },
        {
          ...
          fullDescription:
            "Turn your healthcare data into actionable insights with our powerful analytics platform. Monitor KPIs, identify trends, and make data-driven decisions across clinical, operational, and financial domains.",
          benefits: [
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-hidden ">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute bottom-0 translate-y-1/2 left-8">
                <div className="bg-white rounded-full p-5 shadow-xl">
                  <i
                    className={`fas ${expandedFeature.icon} text-3xl text-blue-600`}
                  ></i>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 pt-12">
              <div className="flex flex-col sm:flex-row justify-between sm:items-start mb-6 gap-4">
                <div>
                  ...
                  {expandedFeature.badge && (
                    <span
                      className={`inline-block px-3 py-1 text-xs font-bold rounded-full mt-2 ${getBadgeColorClass(
                        expandedFeature.badge,
                        "bg"
                      )} ${getBadgeColorClass(expandedFeature.badge, "text")}`}
                    >
                      {expandedFeature.badge}
                    </span>
                  )}
              ...
              <p className="text-gray-600 mb-8 text-lg">
                {expandedFeature.fullDescription}
              </p>
              ...
              <div className="rounded-xl border border-gray-200 p-6 mb-8">
                ...
                <p className="italic text-gray-600">
                  "The {expandedFeature.title} feature has completely
                  transformed how we operate. We've seen dramatic improvements
                  in efficiency and staff satisfaction."
                </p>
      ...
      <section id="features" className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <span className="inline-block px-3 py-1 bg-blue-100 text-blue-600 font-semibold text-xs rounded-full mb-3">
              POWERFUL FEATURES
            </span>
            ...
            <div className="inline-flex flex-wrap justify-center gap-2 sm:gap-4 mb-8 p-1.5 bg-gray-100 rounded-full shadow-inner">
              {Object.keys(featureCategories).map((category) => (
                ...
                >
                  <i
                    className={`fas ${featureCategories[category].icon} mr-2`}
                  ></i>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featureCategories[activeFeatureCategory].features.map(
              (feature, index) => (
                <div
                  key={feature.id}
                ...
                >
                  <div
                    className={`feature-box h-full rounded-xl ${
                      hoveredFeature === feature.id ? "is-flipped" : ""
                    }`}
                  >
                    {/* Front Card */}
                      ...
                      <div className="bg-white rounded-xl p-6 h-full border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
                        <div>
                          <div className="flex justify-between">
                            ...
                            {feature.badge && (
                              <span
                                className={`inline-block px-3 py-1 text-xs font-bold rounded-full ${getBadgeColorClass(
                                  feature.badge,
                                  "bg"
                                )} ${getBadgeColorClass(
                                  feature.badge,
                        ...
                        <div>
                          <button
                            ...
                            className={`${getCategoryColorClass(
                              ...
                              "hover",
                              100
                            )} px-4 py-2 rounded-lg font-medium transition-colors w-full flex items-center justify-center group`}
                    ...
                    <div className="feature-face feature-back">
                      <div
                        className={`${getCategoryColorClass(
                          "bg",
                          600
                        )} rounded-xl p-6 h-full shadow-xl flex flex-col justify-between text-white`}
                      >
                        <div>
                          ...
                          <ul className="space-y-2 mb-6">
                            ...
                            <li className="text-white/80 italic text-sm">
                              ...and more benefits
                            </li>
                          </ul>
                        </div>
          ...
          {/* Action Banner */}
          <div
            className="mt-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white text-center shadow-xl"
            data-aos="fade-up"
          >
            ...
            <p className="text-blue-100 mb-6 max-w-3xl mx-auto">
              Join over 5,000+ healthcare facilities already using MedCare HMS
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16" data-aos="fade-up">
            <span className="inline-block px-3 py-1 bg-green-100 text-green-600 font-semibold text-xs rounded-full mb-3">
              OUR SERVICES
            </span>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Advanced healthcare services integrated with our modern management
              system
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              >
                ...
                <div className="p-8">
                  <div
                    className={`bg-${service.color}-100 text-${service.color}-600 w-16 h-16 rounded-full flex items-center justify-center mb-6 transition-transform group-hover:scale-110 duration-300`}
                  >
      ...
      <section id="testimonials" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16" data-aos="fade-up">
            <span className="inline-block px-3 py-1 bg-purple-100 text-purple-600 font-semibold text-xs rounded-full mb-3">
              TESTIMONIALS
            </span>
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-12">
            <div className="md:w-1/2" data-aos="fade-right">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                ...
                their operations with MedCare HMS. Get started today and
              ...
              <div className="mt-8 flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm text-white/90 font-medium">
                    Joined by 500+ healthcare facilities
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer
        id="contact"
        className="bg-gray-800 text-gray-300 py-16 px-4 relative"
      >
        {/* Back to top button */}
        <button
          onClick={scrollToTop}
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div data-aos="fade-up" data-aos-delay="0">
            ...
            <p className="mb-6 text-gray-400 leading-relaxed">
              ...
              all sizes. Streamline operations and improve patient care with our
              advanced system.
            </p>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="hover:text-white transition-all hover:pl-1 duration-200 block flex items-center text-gray-400"
                >
                  <i className="fas fa-question-circle text-xs mr-2 text-blue-400"></i>{" "}
                  Help Center
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-white transition-all hover:pl-1 duration-200 block flex items-center text-gray-400"
                >
                  <i className="fas fa-file-alt text-xs mr-2 text-blue-400"></i>{" "}
                  Documentation
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-white transition-all hover:pl-1 duration-200 block flex items-center text-gray-400"
                >
                  <i className="fas fa-shield-alt text-xs mr-2 text-blue-400"></i>{" "}
                  Privacy Policy
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-white transition-all hover:pl-1 duration-200 block flex items-center text-gray-400"
                >
                  <i className="fas fa-gavel text-xs mr-2 text-blue-400"></i>{" "}
                  Terms of Service
                </a>
              </li>
            </ul>
        ...
        >
          <p className="text-gray-400">
            ...
            | Designed with <i className="fas fa-heart text-red-500"></i>
          </p>
        </div>
      </footer>
